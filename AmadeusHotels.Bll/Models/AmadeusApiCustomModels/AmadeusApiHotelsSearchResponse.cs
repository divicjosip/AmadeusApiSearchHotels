...
namespace AmadeusHotels.Bll.Models.AmadeusApiCustomModels
{
    ...
    public class AmadeusApiHotelItem
    {
        ...
        //public List<DescriptionItem> Desctiption { get; set; }

        //public DescriptionItem EnglishDescription
        //{
        //    get
        //    {
        //        return DesctiptionItems.FirstOrDefault(x => x.Lang == "en") ?? DesctiptionItems.First();
        //    }
        //}
